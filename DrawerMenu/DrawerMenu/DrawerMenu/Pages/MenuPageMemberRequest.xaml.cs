...
{
    public partial class MenuPageMemberRequest : MasterDetailPage
    {
        ...
        public MenuPageMemberRequest(string RequestedPostedUserId, string PrayerRequestId)
        {
            ...
            Application.Current.Properties["PrayerRequestSpamId"] = PrayerRequestId; // For making as spam we are passing it
            InitializeComponent();
